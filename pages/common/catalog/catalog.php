    ...
    <div class="container">
        ...
        <div class="catalog__wrap">
            ...
            <div class="card card_lg catalog__item jsShowPopup">
                ...
                <div class="card__body">
                    <div class="card__title">
                        Морской круиз в Анапу <i class="fa fa-caret-right" aria-hidden="true"></i>
                    </div>
                    <div class="card__text">
                        <span class="card__text_bold">Маршрут:</span> Сочи-Лазаревское-Геленджик-Анапа <br>
                        <span class="card__text_bold">Продолжительность:</span> 10&nbsp;ч.&nbsp;0&nbsp;мин.
                    </div>
            ...
            <div class="card card_sm catalog__item jsShowPopup">
                ...
                <div class="card__body">
                    <div class="card__title">
                        Обзорная морская прогулка с&nbsp;экскурсией&nbsp;<i class="fa fa-caret-right" aria-hidden="true"></i>
                    </div>
                    <div class="card__text">
                        <span class="card__text_bold">Маршрут:</span> Сочи-Адлер-Сочи (без высадки) <br>
                        <span class="card__text_bold">Продолжительность:</span> 1&nbsp;ч.&nbsp;0&nbsp;мин.
                    </div>
            ...
            <div class="card card_sm catalog__item jsShowPopup">
                ...
                <div class="card__body">
                    <div class="card__title">
                        Морская прогулка в&nbsp;Геленджик&nbsp;<i class="fa fa-caret-right" aria-hidden="true"></i>
                    </div>
                    <div class="card__text">
                        <span class="card__text_bold">Маршрут:</span> Сочи-Туапсе-Геленджик <br>
                        <span class="card__text_bold">Продолжительность:</span> 12&nbsp;ч.&nbsp;30&nbsp;мин.
                    </div>
            ...
            <div class="card card_md catalog__item jsShowPopup">
                ...
                <div class="card__body">
                    <div class="card__title">
                        Морская прогулка в&nbsp;Абрау-Дюрсо&nbsp;<i class="fa fa-caret-right" aria-hidden="true"></i>
                    </div>
                    <div class="card__text">
                        <span class="card__text_bold">Маршрут:</span> Сочи-Абрау-Дюрсо<br>
                        <span class="card__text_bold">Продолжительность:</span> 11&nbsp;ч.&nbsp;0&nbsp;мин.
                    </div>
                    <div class="card__price">14 800 руб.</div>
                </div>
            </div>
        ...
        <div class="catalog__btn">
            <button class="btn btn_arrow">Больше&nbsp;круизов <i class="fa fa-caret-down" aria-hidden="true"></i></button>
        </div>
